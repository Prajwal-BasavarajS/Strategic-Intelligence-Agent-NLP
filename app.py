...
# ---- CEO focus: let the executive choose what to see -----------------------
# The pipeline analyzes everything; this lets the CEO focus the view on what
# they asked for (e.g. "just show me the risks"). It filters the display only;
# the underlying analysis is unchanged.
st.markdown("#### What would you like to focus on?")
FOCUS = st.radio(
    "CEO focus",
    ["Full briefing", "Risks", "Opportunities", "Sentiment", "Recommendations"],
    horizontal=True,
...
def show(part: str) -> bool:
    """Whether a given section should render under the current CEO focus."""
    if FOCUS == "Full briefing":
        return True
    return FOCUS == part


if show("Full briefing"):
...
# The CEO briefing always shows in the full view (it's the executive summary).
if show("Full briefing"):
